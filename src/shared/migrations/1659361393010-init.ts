...
export class init1659361393010 implements MigrationInterface {
    name = 'init1659361393010'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "quotes" ("quoteid" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_userid" character varying NOT NULL, "fk_posterid" uuid NOT NULL, "content" character varying(777) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_iduser" uuid NOT NULL, CONSTRAINT "PK_c3c5e58a021c22307cc915b3779" PRIMARY KEY ("quoteid"))`);
        ...
        await queryRunner.query(`CREATE TABLE "post" ("postid" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_iduser" character varying NOT NULL, "content" character varying(777) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "fk_userid" uuid NOT NULL, CONSTRAINT "PK_87e77b553297ad798e5ce2203fc" PRIMARY KEY ("postid"))`);
