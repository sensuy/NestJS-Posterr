...
export class init1659766436830 implements MigrationInterface {
    name = 'init1659766436830'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "quotes" ("quoteid" SERIAL NOT NULL, "fk_iduser" uuid NOT NULL, "fk_posterid" uuid NOT NULL, CONSTRAINT "PK_c3c5e58a021c22307cc915b3779" PRIMARY KEY ("quoteid"))`);
        ...
        await queryRunner.query(`CREATE TABLE "repost" ("repostid" SERIAL NOT NULL, "fk_postid" uuid NOT NULL, "fk_repostid" uuid NOT NULL, CONSTRAINT "PK_c7fce2ee2de751ceacf3989dcf3" PRIMARY KEY ("repostid"))`);
        ...
        await queryRunner.query(`ALTER TABLE "repost" ADD CONSTRAINT "FK_71fe5ee40ddd5839b1c917f2756" FOREIGN KEY ("fk_repostid") REFERENCES "post"("postid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "repost" DROP CONSTRAINT "FK_71fe5ee40ddd5839b1c917f2756"`);
